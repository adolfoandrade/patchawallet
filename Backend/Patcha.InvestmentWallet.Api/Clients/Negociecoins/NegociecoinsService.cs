...
namespace Patcha.InvestmentWallet.Api.Services.Negociecoins
{
    public class NegociecoinsService : BaseApi, INegociecoinsService
    {
        public NegociecoinsService(HttpClient httpClient) : base(httpClient)
        {
        }

        public Task<BestPriceToBuyViewModel> GetBestPriceToBuyAsync(NegociecoinsOrderBook orderBook, decimal min_value = 2000)
        {
            return Task.Factory.StartNew(() => {
                ...
                {
                    best_price_to_buy_vm.Exchange = "Negociecoins";
        ...
        public Task<BestPriceToSellViewModel> GetBestPriceToSellAsync(NegociecoinsOrderBook orderBook, double btc_amount)
        {
            return Task.Factory.StartNew(() => {
                ...
                {
                    best_price_to_sell_vm.Exchange = "Negociecoins";
        ...
        public async Task<NegociecoinsOrderBook> GetOrderBookAsync(string coin = "btcbrl")
        {
            return await GetAsync<NegociecoinsOrderBook>(NegociecoinsQueryStringService.AppendQueryString(coin + "/orderbook"));
        }
    }
}
