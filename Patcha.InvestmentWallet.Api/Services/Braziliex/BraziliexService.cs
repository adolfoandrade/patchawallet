...
namespace Patcha.InvestmentWallet.Api.Services.Braziliex
{
    public class BraziliexService : BaseApi, IBraziliexService
    {
        public BraziliexService(HttpClient httpClient) 
            : base(httpClient)
        {
        }
        ...
        public Task<BestPriceToSellViewModel> GetBestPriceToSellAsync(BraziliexOrderBook braziliexOrderBook, double btc_amount)
        {
            return Task.Factory.StartNew(() => {
                ...
                var prices_to_sell = braziliexOrderBook.Bids;
                ...
                {
                    best_price_to_sell_vm.Exchange = "Braziliex";
